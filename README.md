...
пользователей, участвующих в двух группах теста одновременно, изучил данные о пользовательской активности, провел исследовательский анализ данных, дал оценку результатов A/B-тестирования. <br/> | python, pandas, numpy, matplotlib, seaborn, math, stats, plotly, scipy    |
