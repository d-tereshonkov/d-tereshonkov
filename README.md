...
| 5.   | [Проверка корректности проведения А/В теста и анализ его результатов](https://github.com/d-tereshonkov/dt_portfolio/tree/main/project_5) | Оценил корректность проведения теста, удостовелился, что нет пересечений с конкурирующим тестом и нет пользователей, участвующих в двух группах теста одновременно, изучил данные о пользовательской активности, провел исследовательский анализ данных, дал оценку результатов A/B-тестирования.             | python, pandas, numpy, matplotlib, seaborn, math, stats, plotly, scipy, datetime |
| 6.   | [Проект по SQL: Сервис для чтения книг](https://github.com/d-tereshonkov/dt_portfolio/tree/main/project_6) | Компания решила быть на волне и купила крупный сервис для чтения книг по подписке. Проанализировал базу данных. В ней — информация о книгах, издательствах, авторах, а также пользовательские обзоры книг. Эти данные помогли сформулировать ценностное предложение для нового продукта.             | python, pandas, sqlalchemy, psycopg2 |
